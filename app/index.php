...
$host = 'ronnakrit'; // แก้ไขให้ตรงกับค่าทีอยู่ใน Docker Compose หรือ .env
$user = 'ronnakrit'; // แก้ไขให้ตรงกับค่าที่อยู่ใน Docker Compose หรือ .env
$db   = 'ronnakrit'; // แก้ไขให้ตรงกับค่าที่อยู่ใน Docker Compose หรือ .env
